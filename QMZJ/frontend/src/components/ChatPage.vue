<template>
    <div class="flex-col justify-start items-center relative page">
        ...
        <span class="text text_2 pos">智能问答</span>
            ...
            <el-container style="height: 100%; width: 100%;">
                    ...
                    <el-menu :default-active="activeConversationId" @select="selectConversation"
                        ...
                        <el-menu-item v-for="conversation in conversations" :key="conversation.id"
                            ...
                            <el-button type="text" icon="el-icon-delete"
                                @click.stop="deleteConversation(conversation.id)"></el-button>
                        </el-menu-item>
                    </el-menu>
                </el-aside>
                <!-- 右侧聊天区域 -->
                <el-container>
                    ...
                    <el-footer class="send-message">
                        <el-input class="" v-model="newMessage" placeholder="输入消息..." @keyup.enter.native="sendMessage"
                            clearable>
                            <template #append>
...
export default {
        ...
        async startNewConversation() {
            ...
            try {
                ...
                this.conversations.unshift({
                    ...
                    preview: '新对话',
                    messages: [ { role: 'assistant', content: newConv.opening_message } ] 
                });
        ...
        async selectConversation(id) {
            ...
            if (!conversation.messages || conversation.messages.length === 0) {
                try {
                    ...
                    if (historyMessages.length > 1 && historyMessages[1].content)
                        conversation.preview = historyMessages[1].content.slice(0, 10);
                    else
    ...
    async mounted() {
        if (this.$route.params.need_reload) {
