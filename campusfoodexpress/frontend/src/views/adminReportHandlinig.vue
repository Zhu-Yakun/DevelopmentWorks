<template>
    <div class="report-handling" :back="'/admin'">
        ...
        <div class="report-handling-box">
            ...
            <a-table :columns="columns" :data="filteredReports" :pagination="false">
                <template #image="{ record }">
                    <img :src="record.image_path || 'https://via.placeholder.com/100'" alt="举报图片" class="image-preview"
                        @error="onImageError" />
                </template>
        ...
        <!-- 处理模态框 -->
        <a-modal v-model:visible="replyModalVisible" title="处理举报" @cancel="closeReplyModal" @ok="submitReply">
